 ...
 * 
 * *qname    - Almacena la respuesta. Posee los pares (longitud, dato) del nombre por el cual se consulta. 
 ...
 *          El metodo sobreescribe el valor de qname para que se lo transforme a una cadena de caracteres tal que a cada seccion se la separa por un punto.
 *          Es decir, en un principio tendra 3www3uns3edu2ar y, al finalizar el metodo su valor almacenara www.uns.edu.ar
 */
